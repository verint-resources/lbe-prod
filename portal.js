...
var _appConfig = {
                ...
                $(_app.funnelBack.box).on("input focus", function () {
                    (_app.funnelBack.q = $(this).val()),
                        _app.funnelBack.q.length > 2
                            ...
                            : ($(_app.funnelBack.results).html('<ul role="listbox" id="suggested" class="header-search__wrapper header-search__results-list" aria-label="Suggestions keywords can be selected by up and down arrow keys and page links can be accessed by tab"></ul>'),
                    ...
                    $(document).on("click focus keyup", function (e) {
                        $(e.target).is(_app.funnelBack.section + " *") ||
                            ($(_app.funnelBack.section)
                                ...
                                .html('<ul role="listbox" id="suggested" class="header-search__wrapper header-search__results-list" aria-label="Suggestions keywords can be selected by up and down arrow keys and page links can be accessed by tab"></ul>'),
                            $(_app.funnelBack.box).val(_app.funnelBack.q).attr("aria-expanded", "false"));
                    }),
    ...
    customMember: function (){
        ...
        footerText: function () {
            return (
                '<section class="general-cta full-width">  <div class="general-cta__wrapper content-wrapper">    <h2 class="general-cta__title">Council news directly to you</h2>    <p class="general-cta__description">      The latest news in your inbox every week. Council news, community updates,      local events and more.    </p>    <a      href="https://enfield-council.msgfocus.com/k/Enfield-Council/sign_up"      class="btn general-cta__btn"      target="_blank"    >      <span class="sr-only">Sign up</span>      Sign up    </a>  </div></section><footer class="footer full-width" id="footer">  <h2 class="sr-only">Footer</h2>  <div class="footer__wrapper content-wrapper">    <div class="footer__logo__wrapper">      <img        class="footer__logo"        src="' + _appConfig.squizDomain + '/__data/assets/file/0015/492/logo-enfield-white.svg"        alt=""      />      <div class="footer-links__address">        <address>          Civic Centre<br />          Silver Street<br />          Enfield<br />          EN1 3XA        </address>        <a          href="https://www.google.com/maps/dir//enfield.council/@51.6545994,-0.1501082,12z/data=!3m1!4b1!4m9!4m8!1m1!4e2!1m5!1m1!1s0x48761f3a53b49683:0x447ef8d8065cc230!2m2!1d-0.0800687!2d51.6546202"          class="footer-links__address-map"          target="_blank"          >View Civic Centre on map</a        >      </div>    </div>    <section class="footer-links">      <nav aria-label="Footer links">        <ul class="footer-links__list">          <li class="footer-links__item">            <a              href="' + _appConfig.squizDomain + '/council-opening-hours"              class="footer-links__link"            >              Opening hours            </a>          </li>          <li class="footer-links__item">            <a              href="' + _appConfig.squizDomain + '/contact-us"              class="footer-links__link"            >              Contact us            </a>          </li>          <li class="footer-links__item">            <a              href="' + _appConfig.squizDomain + '/privacy-notice"              class="footer-links__link"            >              Privacy notice            </a>          </li>          <li class="footer-links__item">            <a              href="' + _appConfig.squizDomain + '/privacy-notice#cookies-and-similar-technologies"              class="footer-links__link"            >              Cookie policy            </a>          </li>          <li class="footer-links__item">            <a              href="' + _appConfig.squizDomain + '/terms-of-use"              class="footer-links__link"            >              Terms of use            </a>          </li>          <li class="footer-links__item">            <a              href="' + _appConfig.squizDomain + '/accessibility"              class="footer-links__link"            >              Accessibility statement            </a>          </li>          <li class="footer-links__item">            <a              href="' + _appConfig.squizDomain + '/organisation-structure"              class="footer-links__link"            >              Organisation structure            </a>          </li>          <li class="footer-links__item">            <a              href="' + _appConfig.squizDomain + '/enfield-connected?formID=member_enquiry"              class="footer-links__link"            >              Raise a Members Enquiry            </a>          </li>        </ul>      </nav>    </section>    <section class="footer-social">      <h3 class="footer__title">Connect with us</h3>      <nav aria-label="Social media links">        <ul class="footer-social__list">          <li class="footer-social__item">            <a              href="https://www.facebook.com/EnfieldCouncilUK/"              class="footer-social__link"              target="_blank"            >              <img                src="' + _appConfig.squizDomain + '/__data/assets/file/0012/516/fb.svg"                alt="Go to Facebook"              />            </a>          </li>          <li class="footer-social__item">            <a              href="https://www.linkedin.com/company/london-borough-of-enfield"              class="footer-social__link"              target="_blank"            >              <img                src="' + _appConfig.squizDomain + '/__data/assets/file/0010/514/linkedin.svg"                alt="Go to Linkedin"              />            </a>          </li>          <li class="footer-social__item">            <a              href="https://www.youtube.com/user/EnfieldCouncil"              class="footer-social__link"              target="_blank"            >              <img                src="' + _appConfig.squizDomain + '/__data/assets/file/0013/517/youtube.svg"                alt="Go to Youtube"              />            </a>          </li>          <li class="footer-social__item">            <a              href="https://twitter.com/EnfieldCouncil"              class="footer-social__link"              target="_blank"            >              <img                src="' + _appConfig.squizDomain + '/__data/assets/image/0013/43141/logo-white.png"                alt="Go to Twitter"              />            </a>          </li><li class="footer-social__item">            <a href="https://www.instagram.com/enjoyenfield/" class="footer-social__link" target="_blank">              <img src="' + _appConfig.squizDomain + '/__data/assets/file/0024/30597/Instagram.svg" alt="Go to Instagram"/>            </a>          </li>         </ul>      </nav>    </section>  </div>  <section class="footer__bottom">    <div class="footer__bottom-wrapper content-wrapper">      <section class="footer-copyright">        <p class="footer-copyright__desc">© 2023 Enfield Council</p>      </section>    </div>  </section></footer>'
            );
        },
        init: function () {
