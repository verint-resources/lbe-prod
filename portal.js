    ...
    _app = {
        ...
        funnelBack: {
            ...
            search: function () {
                ...
                let e = "";
                (e += '<ul role="listbox" id="suggested" class="header-search__wrapper header-search__results-list" aria-live="polite" aria-label="Search result list">'),
                    ...
                    $(_app.funnelBack.results).html(
                        '<ul role="listbox" id="suggested" class="header-search__wrapper header-search__results-list" aria-live="polite" aria-label="Search result list" ><li id="search-suggested" role="presentation" class="header-search__category header-search__category--full"></li><li id="search-services" role="presentation" class="header-search__category"></li><li id="search-news" role="presentation" class="header-search__category"></li></ul>'
                    ),
                ...
                $(_app.funnelBack.box).on("input focus", function () {
                    (_app.funnelBack.q = $(this).val()),
                        _app.funnelBack.q.length > 2
                            ...
                            : $(_app.funnelBack.results).html('<ul role="listbox" id="suggested" class="header-search__wrapper header-search__results-list" aria-live="polite" aria-label="Search result list" ></ul>');
                }),
                    $(document).on("click focus keyup", function (e) {
                        $(e.target).is(_app.funnelBack.section + " *") ||
                            ($(_app.funnelBack.section)
                                ...
                                .html('<ul role="listbox" id="suggested" class="header-search__wrapper header-search__results-list" aria-live="polite" aria-label="Search result list" ></ul>'),
