      ...
      setTimeout(function () {
        ...
        if (profileData['IDP-sub'] && event.authenticated === false){
            ...
            if(!currentURL.includes("/register?")){
                window.location.href = "https://lbe.portal.uk.empro.verintcloudservices.com/site/enfield/register?redirectUrl=https://lbe.portal.uk.empro.verintcloudservices.com/site/enfield/mydetails";
            }
        }
